...
namespace UnityTemplateProjects
{
    public class FlyCameraController : MonoBehaviour
    {
        class FlyCameraState
        {
            ...
            public void LerpTowards(FlyCameraState target, float positionLerpPct, float rotationLerpPct)
            {
        ...
        FlyCameraState m_TargetCameraState = new FlyCameraState();
        FlyCameraState m_InterpolatingCameraState = new FlyCameraState();
